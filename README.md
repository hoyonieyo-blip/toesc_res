...
>
> I'm Korean, and my English isn't very good.
> Some parts of this README were translated using Naver Papago or ChatGPT.
> So there may be some awkward expressions.
> Sorry!
...
**`toesc/`** 폴더는 제가 만든 패키지입니다.

파일을 직접 열어서 실행할 때 출력 내용을 다 확인하지 못하고 프로그램이 바로 종료되는 문제가 있기 때문에,
그런 문제를 막기 위해 프로그램 끝에 `toesc.korea.end_process()`를 사용할 수 있도록 만들었습니다.
